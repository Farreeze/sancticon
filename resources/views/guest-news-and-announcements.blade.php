    ...
    <body class="font-sans text-gray-900 antialiased bg-no-repeat bg-cover bg-center min-h-screen" style="background-image: url('/images/bg/bg1.jpg');">
        ...
        <div class="w-full p-7">
            <div class="w-full p-5 bg-white bg-opacity-40 rounded-lg shadow-md">
                <div>
                    <h2 class="font-bold text-2xl text-black">News and Announcements</h2>
                </div>
                ...
                @foreach ($newsAndAnnouncements as $newsAndAnnouncement)
                    <div class="w-full bg-white bg-opacity-40 rounded-lg flex flex-col p-5 mt-3 text-lg">
                        <div>
                            ...
                            <p class="text-black max-w-full whitespace-normal break-words mt-3">{{ $newsAndAnnouncement->desc }}</p>
                            <div class="flex flex-row mt-3">
                                <p class="text-black max-w-full whitespace-normal break-words font-bold">Date:</p>
                                <p class="text-black max-w-full whitespace-normal break-words ml-3">{{ $newsAndAnnouncement->date }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
